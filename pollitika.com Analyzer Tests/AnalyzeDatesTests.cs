...
namespace pollitika.com_Analyzer_Tests
{
    ...
    public class AnalyzeDatesTests
    {
        ...
        {
            Post post = AnalyzePosts.AnalyzePost("http://pollitika.com/socijalist-ili", _repo);
        ...
        {
            Post post = AnalyzePosts.AnalyzePost("http://pollitika.com/che-guevarina-skola", _repo);
