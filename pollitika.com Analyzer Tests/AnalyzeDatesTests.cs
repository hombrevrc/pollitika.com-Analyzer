...
namespace pollitika.com_Analyzer_Tests
{
    ...
    public class AnalyzeDatesTests
    {
        ...
        {
            Post post = AnalyzePosts.AnalyzePost("http://pollitika.com/hrvatsko-zdravstvo-i-sovjetska-automobilska-industrija", _repo, false);
