...
namespace pollitika.com_Analyzer_Tests
{
    ...
    public class AnalyzeVotesTests
    {
        ...
        public void AnalyzePost_TestGetPostVotes1()
        {
            ...
            List<Vote> listVotes = AnalyzeVotes.ScrapeListVotesForNode(15397, "node", _repo);
        ...
        public void AnalyzePost_TestGetPostVotes2()
        {
            ...
            List<Vote> listVotes = AnalyzeVotes.ScrapeListVotesForNode(14171, "node", _repo);
        ...
        public void AnalyzePost_TestGetPostVotes3_TwoPageOfVotes()
        {
            ...
            List<Vote> listVotes = AnalyzeVotes.ScrapeListVotesForNode(11768, "node", _repo);
        ...
        public void AnalyzePost_TestGetPostVotes4()
        {
            ...
            List<Vote> listVotes = AnalyzeVotes.ScrapeListVotesForNode(2898, "node", _repo);
        ...
        public void AnalyzePost_TestGetPostVotes5_NoVotes()
        {
            ...
            List<Vote> listVotes = AnalyzeVotes.ScrapeListVotesForNode(406, "node", _repo);
        ...
        public void AnalyzePost_TestGetPostVotes6_NoVotes()
        {
            ...
            List<Vote> listVotes = AnalyzeVotes.ScrapeListVotesForNode(50, "node", _repo);
        ...
        public void AnalyzePost_TestGetPostVotes7_FourPagesOfVotes()
        {
            ...
            List<Vote> listVotes = AnalyzeVotes.ScrapeListVotesForNode(6085, "node", _repo);
