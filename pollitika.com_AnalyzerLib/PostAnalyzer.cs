...
namespace pollitika.com_AnalyzerLib
{
    public class PostAnalyzer
    {
        ...
        public static string ScrapePostAuthor(HtmlNode mainNode, out string authorName, out string authorHtmlName)
        {
            HtmlNode userDetails = mainNode.Descendants().Single(n => n.GetAttributeValue("class", "").Equals("breadcrumb"));
            ...
            {
                var userDetails1 = mainNode.Descendants().Where(n => n.GetAttributeValue("class", "").Equals("article-meta article-meta-top")).ToList();
